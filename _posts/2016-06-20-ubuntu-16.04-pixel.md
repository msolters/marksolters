...
![screenshot of df -h output showing SD card]({{site.url}}/assets/images/sd-card-df-h.png)
...
![UI scale set to 2x in Ubuntu Display settings]({{site.url}}/assets/images/unity-pixel-ui-scale.png)
...
![verifying linux samus kernel using uname -a]({{site.url}}/assets/images/samus-kernel-uname-a.png)
...
![output of aplay -l showing bdw-rt5677 device]({{site.url}}/assets/images/samus-bdwrt5677.png)
...
![Ubuntu Sound settings showing bdw-rt5677 devices]({{site.url}}/assets/images/unity-pixel-sound.png)
...
![Ubuntu Sound settings showing bdw-rt5677 device as microphone input]({{site.url}}/assets/images/ubuntu-pixel-sound-mic.png)
...
![Ubuntu's Keyboard settings dialog showing shortcuts]({{site.url}}/assets/images/ubuntu-keyboard-shortcuts.png)
...
![Ubuntu Keyboard settings dialog showing volume shortcuts]({{site.url}}/assets/images/ubuntu-keyboard-shortcuts-volume.png)
...
![Ubuntu Keyboard settings dialog showing brightness shortcuts]({{site.url}}/assets/images/ubuntu-keyboard-shortcuts-brightness.png)
